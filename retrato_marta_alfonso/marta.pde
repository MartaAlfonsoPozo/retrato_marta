void marta(float posx, float posy) {
  ...
  arc(m*12,m*11.6,m*3+m/4,m*3+m/4,radians(0),radians(90));
  line(m*12.5,m*13.6,m*2.6,m*13.6);
  arc(m*3,m*11.6,m*3+m/4,m*3+m/4,radians(90),radians(180));
  line(m*3,m*6,m,m*8);
  line(m*12,m*6,m*14,m*8);
  
  //rostro
  ellipse(m*6,m*7,m-m/2,m-m/2);
  ellipse(m*9,m*7,m-m/2,m-m/2);
  arc(m*6,m*6.8,m+m/4,m+m/4,radians(200),radians(340));
  arc(m*9,m*6.8,m+m/4,m+m/4,radians(200),radians(340));
